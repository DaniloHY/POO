...
agenda.AlterarContato("João Silva", "joao.novo@email.com", "12345-5678");
agenda.ListarContatos();
...
caixa.RegistrarUsuario("usuario1", "senha1");

if (caixa.Login("usuario1", "senha1"))
{
    Console.WriteLine("Login realizado com sucesso!");

    caixa.Depositar(1000);
    Console.WriteLine($"Saldo: {caixa.VerSaldo():C}");
    ...
    foreach (var item in caixa.VerExtrato())
    {
